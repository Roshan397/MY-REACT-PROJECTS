  ...
  return (
    <div style={{backgroundColor:"purple",height:"100vh"}}>
        <Container style={{paddingLeft:"420px",paddingTop:"70px"}}>
            ...
            <div><img src='./mainlogo1.jpg' alt='logo' style={{height:"100px"}}></img></div>
                ...
                <br/>
                <br/>
                <Link to='/'><Button variant="contained" style={{width:"220px",borderRadius:"10px",color:"white",backgroundColor:"purple"}}>Sign up</Button></Link>
                </div>
            </Card>
                <br/>
            <Card style={{width:"360px",textAlign:"center"}}>
                <p>Have an account?<Link to='/' style={{textDecoration:"none",color:"purple"}}>Log in</Link></p> 
            </Card>
        </Container>
    </div>
  )
